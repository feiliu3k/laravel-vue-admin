...
<script lang="ts">
    ...
    import {user_list, user_save, user_remove} from '../../../services/index';
    ...
    export default class UserTabPage extends Vue {
        ...
        public mounted() {
            ...
            this.$nextTick(function () {
                this.$on('update', async function () {
                    ...
                    let {success, data} = await user_list();
                    if (success) {
                        self.list = data;
                    }
                });
        ...
        public async saveBtn(formName:string) {
            let self = this;
            self.remoteValidate(self, formName, user_save).then(function (data:any) {
                if (data) {
